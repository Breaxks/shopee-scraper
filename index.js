...
async function getDiscover(pageNumber = 1) {
    try {
        const limit = 2; // limit feeds dalam page
            ...
            if (feed.type === "item_card" && feed.item_card?.item) {
                ...
                const clean = {
                    product_info: {
                        ...
                        estimated_delivery_time: item.estimated_delivery_time.estimated_delivery_time_text,
                    ...
                    rating_info: {
                        ...
                        rating_breakdown: {
                            1: item.item_rating?.rating_count?.[1] || 0,
                            2: item.item_rating?.rating_count?.[2] || 0,
                            3: item.item_rating?.rating_count?.[3] || 0,
                            4: item.item_rating?.rating_count?.[4] || 0,
                            5: item.item_rating?.rating_count?.[5] || 0,
                        },
                    },
                    shop: {
